...
base_dir <- "../../1M_cells/data/eqtls/sct_mqc_demux_lores_newest_log_200624_confine_1m_ut_all_cell_types_eqtlgen/"
...
add_MAST_to_table <- function(eqtl_table, MAST_path, name){
